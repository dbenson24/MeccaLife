...
for "_i" from 1 to 3 do {_dome setVariable[format["bis_disabled_Door_%1",_i],1,true]; _dome animate [format["Door_%1_rot",_i],0];_pdome setVariable[format["bis_disabled_Door_%1",_i],1,true]; _pdome animate [format["Door_%1_rot",_i],0];};
