...
switch(_type) do
{
	...
	case "5489": {_type = ["5489",15000]};
	case "1412": {_type = ["1412",15000]};
	case "1337": {_type = ["1337",15000]};
	case "13371": {_type = ["13371",15000]};
	case "1018": {_type = ["1018",15000]};
	case "4389": {_type = ["4389",15000]};
	case "5894": {_type = ["5894",15000]};
	case "4532": {_type = ["4532",15000]};
	case "5217": {_type = ["5217",15000]};
