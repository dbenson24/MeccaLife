...
[ /* POSITION OF THE GANG ZONE, DISPLAYNAME, X, Y, CAPTURE REWARD, CAPTURE PROC. SPEED, CAPTURE TIME IN MIN*/
	...
	[[08906.83,748.5,0.04],"Tactics Division",450,450,200000,0.05,15,-1,grpNull,false],
	[[12297.96,8883,0.04],"Logistics",450,450,170000,0.05,15,-1,grpNull,false],
	[[10417,8741.18,0.04],"High Command",450,450,250000,0.05,15,-1,grpNull,false]
];
