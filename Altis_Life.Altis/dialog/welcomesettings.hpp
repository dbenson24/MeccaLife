...
class welcomesettings
{
	...
	class controlsBackground
	{
		...
		{
			idc = 6903;
			text = "Welcome to the Mecca AltisLife. Please read the rules on our forums at MeccaGaming.co.<br/> Our TeamSpeak 3 address : meccagaming.myteamspeak.net<br/> What is Auto-Optimize? Auto-Optimize adjusts the game settings so that your game runs at maximum potential. You can also define the settings yourself.";
			x = 0.15;
			y = 0.28;
			w = 0.7;
			h = 0.4;
