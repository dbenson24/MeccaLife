...
_Btn1 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_repairTruck;";
...
_Btn2 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_pulloutAction;";
...
if(playerSide == west) then {
	...
	_Btn2 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_coppulloutAction;";
	...
	_Btn3 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_searchVehAction;";
	
	_Btn4 ctrlSetText localize "STR_vInAct_SearchVehicle";
	_Btn4 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_vehInvSearch;";
	
	_Btn5 ctrlSetText localize "STR_vInAct_Impound";
	_Btn5 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_impoundAction;";
	
	_Btn6 ctrlSetText localize "STR_vInAct_Seize";
    _Btn6 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_seizeAction;";	
	...
	if(_curTarget isKindOf "Ship") then {
		...
		if(typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F"]) then {
			...
			_Btn7 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_flipAction; closeDialog 0;";
	...
	if(typeOf _curTarget == "O_Truck_03_device_F") then {
		...
		_Btn4 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_deviceMine";
	...
	if(playerSide == independent) then { 
		...
		_Btn4 buttonSetAction "if(player distance life_pInact_curTarget > 7) exitWith {hint 'You are too far away.'};[life_vInact_curTarget] spawn life_fnc_searchVehAction;";
		_Btn4 ctrlShow true;
	};
