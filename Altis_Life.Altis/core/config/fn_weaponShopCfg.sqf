			...
			case (FETCH_CONST(life_coplevel) == 4):
			{
				["Lieutenant Equipment Shop",
					[
						...
						["arifle_MXC_Black_F","MXC 6.5mm",170000 * life_donDis],
						["arifle_MX_Black_F","MX 6.5 mm",200000 * life_donDis],
						["arifle_MX_SW_F","Heavy Mx",200000 * life_donDis],
						["100Rnd_65x39_caseless_mag_Tracer","Rubber Bullets",200 * life_donDis],
						["100Rnd_65x39_caseless_mag","100 Round 65x39",2000 * life_donDis],
