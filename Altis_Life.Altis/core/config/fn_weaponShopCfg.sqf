			...
			case (FETCH_CONST(life_coplevel) == 2):
			{
				["Private Equipment Shop",
					[
						...
						["arifle_MXC_Black_F","MXC 6.5mm",7000 * life_donDis],
						["arifle_MX_Black_F","MXC 6.5mm",7000 * life_donDis],
			...
			case (FETCH_CONST(life_coplevel) == 3):
			{
				["Corporal Equipment Shop",
					[
						...
						["MineDetector","Mine Detector",1000 * life_donDis],
						["Binocular","Binocular",100 * life_donDis],
						["NVGoggles_OPFOR","Police Night Vision Goggles",500 * life_donDis],
						["hgun_P07_F","P07 9mm",2000 * life_donDis],
						["hgun_P07_snds_F","P07 9mm Silencer",2500 * life_donDis],
						["30Rnd_9x21_Mag","9mm 30Rnd Mag",500 * life_donDis],
			...
			default
			{
				["Rebel Weapon Shop",
					[
						...
						["hgun_Pistol_heavy_02_F","Zubr .45",25000 * life_donDis],
						["6Rnd_45ACP_Cylinder",".45 ACP 6Rnd Cylinder",500 * life_donDis],	
						
						["arifle_Mk20C_F","Mk20C 5.56 mm (C)",30000 * life_donDis],
						["30Rnd_556x45_Stanag","5.56mm 30rnd STANAG Mag",500 * life_donDis],
						
						["arifle_TRG20_F","TRG-20 5.56mm",20000 * life_donDis],
						["30Rnd_556x45_Stanag","5.56mm 30rnd STANAG Mag",500 * life_donDis],

						["arifle_TRG21_F","TRG-21 5.56mm",20000 * life_donDis],
						["30Rnd_556x45_Stanag","5.56mm 30rnd STANAG Mag",500 * life_donDis],
						
						["arifle_Katiba_F","Katiba 6.5mm",35000 * life_donDis],
