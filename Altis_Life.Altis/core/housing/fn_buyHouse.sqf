...
if(count life_houses >= (LIFE_SETTINGS(getNumber,"house_limit")) && typeOf(_house) != "Land_i_Shed_Ind_F") exitWith {hint format[localize "STR_House_Max_House",LIFE_SETTINGS(getNumber,"house_limit")]};
closeDialog 0;
