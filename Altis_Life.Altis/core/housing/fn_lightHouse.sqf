...
if(_mode) then {
	...
	switch(true) do {
		...
		case ((typeOf _house) in ["Land_i_House_Big_02_V1_F","Land_i_House_Big_02_V2_F","Land_i_House_Big_02_V3_F","Land_i_Shed_Ind_F"]): {_lightSource lightAttachObject [_house,[2,0,3.5]];};
