...
[] spawn {
while {true} do {
waitUntil {uiSleep 5; !isNull (findDisplay 3030)};
...
[] spawn {
while {true} do {
waitUntil {uiSleep 5; !isNull ((findDisplay 64) displayCtrl 101)};
[[format["%1 is using a menu based cheat, please report him.",name player],player],"life_fnc_displayHint",nil,false] spawn BIS_fnc_MP;
...
[] spawn {
while {true} do {
waitUntil {uiSleep 5; !isNull (findDisplay 129)};
closeDialog 0;
};
};
...
[] spawn {
while {true} do {
waitUntil {uiSleep 5; !isNull (uiNamespace getVariable "RscDisplayRemoteMissions")};
[[format["%1 is using a menu based cheat, please report him.",name player],player],"life_fnc_displayHint",nil,false] spawn BIS_fnc_MP;
